...
\begin{tikzpicture}
        ...
        \draw[snake=coil,segment aspect=0,very thick,segment length=20pt,
              ...
              (N1) -> (I1) node [pos=0.5] {\color{orange}?};
        \draw[snake=coil,segment aspect=0,very thick,segment length=20pt,
              line before snake=1mm,line after snake=1mm,->,draw=black!50]
              (N1) -> (I2) node [pos=0.5] {\color{orange}?};
        \draw[snake=coil,segment aspect=0,very thick,segment length=20pt,
              line before snake=1mm,line after snake=1mm,->,draw=black!50]
              (N1) -> (I3) node [pos=0.5] {\color{orange}?};
...
\begin{frame}{Implicit Fission Model -- Eigenvalue Calculations}
