...
\begin{frame}[fragile]{Standard Output --- Header Information}
 ...
 Creating state point statepoint.120.binary...
    \end{semiverbatim}\endgroup
    \end{column}
    \begin{column}{0.35\linewidth}
    \scriptsize
    \begin{itemize}
      \vfill
      \item Inactive Batches (tracklength k-eff reported) 
      \\~
      \\~
      \item Active Batches begin
      \\~
      \\~
      \item K-eff is accumulated
      \\~
      \\~
      \item Binary output file written
    \end{itemize}
  \end{column}
  \end{columns}
\end{frame}
